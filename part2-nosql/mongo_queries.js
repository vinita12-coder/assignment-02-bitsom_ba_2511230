// ============================================
// PART 2: NoSQL DATABASE - MONGODB OPERATIONS
// ============================================
...
db.products.insertMany([
  {
    ...
    "weight_kg": 2.1,
    "ports": ["Thunderbolt 4", "HDMI", "SD Card", "3.5mm Jack"],
    "rating": 4.8,
    "reviews_count": 1250,
    "in_stock": true,
    "created_at": new Date("2023-01-15T10:30:00Z"),
    "updated_at": new Date("2024-03-15T14:25:00Z")
  },
  {
    "_id": "PROD_CLOTH_001",
    "product_id": "CLOTH001",
    ...
    "colors": ["White", "Black", "Navy Blue", "Red", "Gray"],
    ...
    "reviews_count": 450,
    "in_stock": true,
    "created_at": new Date("2023-06-20T08:15:00Z"),
  ...
  },
  {
    ...
    "price": 4.99,
    "stock": 120,
    "expiry_date": new Date("2024-03-25T23:59:59Z"),
    "manufacturing_date": new Date("2024-03-15T06:00:00Z"),
    "shelf_life_days": 10,
    "weight_grams": 500,
    "ingredients": [
      "Whole Wheat Flour",
    ...
    "reviews_count": 890,
    "in_stock": true,
    "best_before": new Date("2024-03-25"),
    "created_at": new Date("2024-03-15T06:30:00Z"),
    "updated_at": new Date("2024-03-15T12:00:00Z")
  }
]);

// ============================================
// OP2: find() — retrieve all Electronics products with price > 2000
// ============================================
db.products.find({
  "category": "Electronics",
  "price": { $gt: 2000 }
